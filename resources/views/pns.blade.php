@extends('layouts.web', ['title' => __('Data PNS Kanwil Kemenag Prov. Kepulauan Bangka Belitung')])
@push('style')
...
@section('main')
            ...
            <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                             <a class="nav-link" id="pns_usia-tab" data-toggle="tab" href="#pns_usia" role="tab" aria-controls="" aria-selected="false">Rentang Usia</a>
                            </li>
                            <li class="nav-item">   
                        ...
                        <div class="tab-pane fade show active" id="pns_chart" role="tabpanel" aria-labelledby="pns_chart_tab">
                                ...
                                <div class="card card-warning shadow">
                                    <div class="card-header">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8 "><h5>GRAFIK DATA PNS KEMENAG BANGKA BELITUNG </h5></div>
                                    ...
                                    <div class="card-body">
                                        <div class="row p-2">
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Persentase Jumlah PNS Kemenag Babel</h5>
                                                        <div id="chart"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Jumlah PNS Berdasarkan Rentang Usia</h5>
                                                        <div id="chart2"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Jumlah PNS Berdasarkan Kualifikasi</h5>
                                                        <div id="chart3"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Jumlah Persentase PNS Berdasarkan Agama</h5>
                                                        <div id="chart4"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="row">
                                                <div class="col-md-8 "><h5> DATA PNS MENURUT JENIS KELAMIN DAN GOLONGAN</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                     <!-- ------- awal Tabel BERDASARKAN USIA---------------------- -->


                    <div class="tab-pane fade" id="pns_usia" role="tabpanel" aria-labelledby="pns_usia_tab">
                        
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PNS MENURUT USIA TAHUN</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                                                        
                                                    </div>
                                                    <div class="col-md-2 text-left ">
                                                        <select class="form-select form-select-lg" id="pilih_usia" aria-label="Default select example">
                                                            <option selected value="{{ $tempstruk->tahun_priode }}">{{ $tempstruk->tahun_priode }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-1 }}">{{ $tempstruk->tahun_priode-1 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-2 }}">{{ $tempstruk->tahun_priode-2 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-3 }}">{{ $tempstruk->tahun_priode-3 }}</option>
                            ...
                            <div class="card-body">
                                    <div class="col-md-12 p-5">
                                        <div class="table-responsive">
                                            ...
                                            <tbody class="list bg-light">
                                            @foreach ($datapns_usia as $temp)
                                                    <tr >
                                                        <td class="text-center">{{ $temp->idx}}</td>
                                                        <!-- <td>{{ $temp->id }}</td> -->
                                                        <td>{{ $temp->nama }}</td>
                                                        <td class="text-center">{{ number_format($temp->min_30) }}</td>
                                                        <td class="text-center">{{ number_format($temp->range_30_39) }}</td>
                                                        <td class="text-center">{{ number_format($temp->range_40_49) }}</td>
                                                        <td class="text-center">{{ number_format($temp->range_50_57) }}</td>
                                                        <td class="text-center">{{ number_format($temp->lebih_57) }}</td>
                                                        <td class="text-center"><strong>{{ number_format($temp->min_30+$temp->range_30_39+$temp->range_40_49+$temp->range_50_57+$temp->lebih_57) }}</strong></td>
                 ...
                 <div class="tab-pane fade " id="pns_kualifikasi" role="tabpanel" aria-labelledby="pns_kualifikasi_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12  ">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PNS MENURUT KUALIFIKASI PENDIDIKAN TAHUN</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                 ...
                 <div class="tab-pane fade show " id="pns_agama" role="tabpanel" aria-labelledby="pns_agama_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PNS MENURUT AGAMA TAHUN</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
...
<script>
    var ChartOptionsPns = {
        ...
        //====================== CHART BERDASARKAN RENTANG USIA ==================
    

            
        var ChartOptionsUsia = {
          series: [{
          data: @json($datachart_usia)
        }],
          chart: {
          height: 290,
          type: 'bar',
        ...
        var chart2 = new ApexCharts(document.querySelector("#chart2"), ChartOptionsUsia);
        chart2.render();
          ...
          series: [{
          data: @json($datachart_kulifikasi)
        }],
          chart: {
          height: 355,
          type: 'bar',
        ...
        var chart3 = new ApexCharts(document.querySelector("#chart3"), ChartOptionsKualifikasi);
        chart3.render();
        ...
        colors: ['#03fc03', '#e117e8', '#f0ca32', '#f23c24','#0394fc','#fc0328'],
        ...
        var chart4 = new ApexCharts(document.querySelector("#chart4"), ChartOptionsAgama);
        chart4.render();
...
$('#pilih_tahun').on('change',function(){
  ...
  var url = 'get_charttatakelolapns/'+this.value;
  ...
  $.ajax({
        ...
        success: function (data) {
            ...
            var datanya=data.datachart_usia;
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelTatakelolaPns/"+tahun+"/jkgol",
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelTatakelolaPns/"+tahun+"/usia",
                ...
                columns: [
                    ...
                    {data: 'range_30_39', name: 'range_30_39',
                      render: function(data,type,row) { 
                ...
                {data: 'range_40_49', name: 'range_40_49',
                      render: function(data,type,row) { 
                    ...
                    {data: 'range_50_57', name: 'range_50_57',
                      render: function(data,type,row) { 
                    ...
                    {data: 'jml_usia',
                      render: function(data,type,row) { 
                          ...
                          data = row.min_30+row.range_30_39+row.range_40_49+row.range_50_57+row.lebih_57;
                          return '<strong>'+nf.format(data)+'</strong>';
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelTatakelolaPns/"+tahun+"/kualifikasi",
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelTatakelolaPns/"+tahun+"/agama",
