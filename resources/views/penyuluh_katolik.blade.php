@extends('layouts.web', ['title' => __('Data Penyuluh Agama Katolik')])
@push('style')
...
@section('main')
            ...
            <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">  
                                <a class="nav-link active" id="katolik_chart-tab" data-toggle="tab" href="#katolik_chart" role="tab" aria-controls="" aria-selected="false">Chart Penyuluh Katolik</a>
                            </li>
                            <li class="nav-item">  
                            <a class="nav-link " id="penyuluhkatolik-tab" data-toggle="tab" href="#penyuluhkatolik" role="tab" aria-controls="" aria-selected="false">Tabel Penyuluh Agama Katolik</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link " id="penyuluhpns-tab" data-toggle="tab" href="#penyuluhpns" role="tab" aria-controls="" aria-selected="false">Tabel Penyuluh PNS Agama Katolik</a>       </li>
                            <li class="nav-item">   
                            <a class="nav-link " id="penyuluhnonpns-tab" data-toggle="tab" href="#penyuluhnonpns" role="tab" aria-controls="" aria-selected="false">Tabel Penyuluh Non PNS Agama Katolik</a>
                            </li>
                        ...
                        <div class="tab-pane fade show active" id="katolik_chart" role="tabpanel" aria-labelledby="katolik_chart_tab">
                        
                                <div class="card card-warning shadow">
                                    <div class="card-header">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8 "><h5>GRAFIK DATA PENYULUH AGAMA KATOLIK </h5></div>
                                    ...
                                    <div class="card-body">
                                        <div class="row p-2">
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Penyuluh Agama Katolik</h5>
                                                        <div id="chart"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Penyuluh Agama Katolik PNS</h5>
                                                        <div id="chart2"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Penyuluh Agama Katolik Non PNS</h5>
                                                        <div id="chart3"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                            ...
                            <!-- ------- TABEL Penyuluh Agama katolik---------------------- -->


                        <div class="tab-pane fade show " id="penyuluhkatolik" role="tabpanel" aria-labelledby="penyuluhkatolik-tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="row">
                                                <div class="col-md-8 "><h5> DATA PENYULUH AGAMA KATOLIK</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                                                        
                                                    </div>
                                                    <div class="col-md-2 text-left ">
                                                        <select class="form-select form-select-lg" id="pilih_katolik" aria-label="Default select example">
                                                            <option selected value="{{ $tempstruk->tahun_priode }}">{{ $tempstruk->tahun_priode }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-1 }}">{{ $tempstruk->tahun_priode-1 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-2 }}">{{ $tempstruk->tahun_priode-2 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-3 }}">{{ $tempstruk->tahun_priode-3 }}</option>
                     ...
                     <div class="tab-pane fade" id="penyuluhpns" role="tabpanel" aria-labelledby="penyuluhpns-tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PNS AGAMA KATOLIK</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                                                        
                                                    </div>
                                                    <div class="col-md-2 text-left ">
                                                        <select class="form-select form-select-lg" id="pilih_pnskatolik" aria-label="Default select example">
                                                            <option selected value="{{ $tempstruk->tahun_priode }}">{{ $tempstruk->tahun_priode }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-1 }}">{{ $tempstruk->tahun_priode-1 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-2 }}">{{ $tempstruk->tahun_priode-2 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-3 }}">{{ $tempstruk->tahun_priode-3 }}</option>
                            ...
                            <div class="card-body">
                                    <div class="col-md-12 p-5">
                                        <div class="table-responsive">
                                        <table id="tabel-pnskatolik" class="table style table-striped table-hover tabel-pnskatolik" style="width:100%">
                                           <thead class="text-white" style="background-color:#5BBCFF">
                                           <tr class="text-center">
                                                    <th rowspan="2" >No</th>
                                                    <th rowspan="2" text-align="center">Kabupaten / Kota</th>
                 ...
                 <div class="tab-pane fade" id="penyuluhnonpns" role="tabpanel" aria-labelledby="penyuluhnonpns-tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12  ">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PENYULUH AGAMA KATOLIK NON PNS</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                                                        
                                                    </div>
                                                    <div class="col-md-2 text-left ">
                                                        <select class="form-select form-select-lg" id="pilih_nonpnskatolik" aria-label="Default select example">
                                                            <option selected value="{{ $tempstruk->tahun_priode }}">{{ $tempstruk->tahun_priode }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-1 }}">{{ $tempstruk->tahun_priode-1 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-2 }}">{{ $tempstruk->tahun_priode-2 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-3 }}">{{ $tempstruk->tahun_priode-3 }}</option>
                            ...
                            <div class="card-body">
                                    <div class="col-md-12 p-5">
                                        <div class="table-responsive">
                                        <table id="tabel-nonpnskatolik" class="table style table-striped table-hover tabel-nonpnskatolik" style="width:100%">
                                        <thead class="text-white" style="background-color:#5BBCFF">
                                        <tr class="text-center">
                                                    <th rowspan="2" >No</th>
                                                    <th rowspan="2" text-align="center">Kabupaten / Kota</th>
...
//    ----------------------- CHART 1 ----------------------------------------------------------
 ...
 //====================== CHART PENYULUH AGAMA katolik ==================

 var ChartOptionsPenyuluhkatolik = {
          series: [{
          data: @json($datachart_penyuluhkatolik)
        }],
          chart: {
          height: 290,
          type: 'bar',
        ...
        var chart = new ApexCharts(document.querySelector("#chart"), ChartOptionsPenyuluhkatolik);
        chart.render();
...
//====================== CHART PENYULUH AGAMA katolik PNS==================
    

            
var ChartOptionsPenyuluhpnskatolik= {
          series: [{
          data: @json($datachart_pnskatolik)
        }],
          chart: {
          height: 290,
          type: 'bar',
        ...
        var chart2 = new ApexCharts(document.querySelector("#chart2"), ChartOptionsPenyuluhpnskatolik);
        chart2.render();
...
var ChartOptionsPenyuluhnonpns = {
          series: [{
          data: @json($datachart_nonpnskatolik)
        }],
          chart: {
          height: 290,
          type: 'bar',
...
$('#pilih_tahun').on('change',function(){
  ...
  var url = 'get_chartkeagamaankatolik/'+this.value;
  ...
  $.ajax({
        ...
        success: function (data) {
            ...
            var datatpenyulukatolik=data.datachart_penyuluhkatolik;
            var datapns_katolik=data.datachart_pnskatolik;
            var datanonpns_katolik=data.datachart_nonpnskatolik;
...
// =========================== untuk Mengubah Data Tabel Keagamaan Penyuluh katolik Berdasarkan tahun=================== 

$('#pilih_katolik').on('change',function(){
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelKeagamaankatolik/"+tahun+"/penyuluhkatolik",
...
$('#pilih_pnskatolik').on('change',function(){
...
var tahun=this.value;
       ...
       $('#pilih_nonpnskatolik').on('change',function(){
