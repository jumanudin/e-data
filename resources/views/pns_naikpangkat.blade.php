@extends('layouts.web', ['title' => __('Data PNS Naik Pangkat dan Ijin Belajar Kanwil Kemenag Prov. Kepulauan Bangka Belitung')])
@push('style')
...
@section('main')
            ...
            <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">   
                                <a class="nav-link" id="pns_ijinkualifikasi-tab" data-toggle="tab" href="#pns_ijinkualifikasi" role="tab" aria-controls="" aria-selected="false">Ijin Belajar</a>
                            </li>
                        </ul>    
                        <br />
                        ...
                        <div class="tab-pane fade show active" id="pns_chart" role="tabpanel" aria-labelledby="pns_chart_tab">
                                ...
                                <div class="card card-warning shadow">
                                    <div class="card-header">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8 "><h5>GRAFIK DATA PNS NAIK PANGKAT KEMENAG BANGKA BELITUNG </h5></div>
                                    ...
                                    <div class="card-body">
                                        <div class="row p-2">
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Persentase Jumlah PNS Naik Pangkat Kemenag Babel</h5>
                                                        <div id="chart"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Jumlah PNS Naik Pangkat Berdasarkan Kualifikasi Pendidiakn</h5>
                                                        <div id="chart2"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Jumlah PNS Naik Pangkat Berdasarkan Agama</h5>
                                                        <div id="chart3"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Jumlah PNS Ijin Belajar</h5>
                                                        <div id="chart4"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="row">
                                                <div class="col-md-8 "><h5> DATA PNS NAIK PANGKAT MENURUT JENIS KELAMIN DAN GOLONGAN</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                 ...
                 <div class="tab-pane fade " id="pns_kualifikasi" role="tabpanel" aria-labelledby="pns_kualifikasi_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12  ">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PNS NAIK PANGKAT MENURUT KUALIFIKASI PENDIDIKAN</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                 ...
                 <div class="tab-pane fade show " id="pns_agama" role="tabpanel" aria-labelledby="pns_agama_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PNS NAIK PANGKAT MENURUT AGAMA </h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                 ...
                 <div class="tab-pane fade show" id="pns_ijinkualifikasi" role="tabpanel" aria-labelledby="pns_ijinkualifikasi_tab">
                        
                        <div class="card card-warning shadow">
                            <div class="card-header">
                            <div class="col-md-12  ">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PNS IJIN BELAJAR MENURUT KUALIFIKASI PENDIDIKAN</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                                                        
                                                    </div>
                                                    <div class="col-md-2 text-left ">
                                                        <select class="form-select form-select-lg" id="pilih_ijinkualifikasi" aria-label="Default select example">
                                                            <option selected value="{{ $tempstruk->tahun_priode }}">{{ $tempstruk->tahun_priode }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-1 }}">{{ $tempstruk->tahun_priode-1 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-2 }}">{{ $tempstruk->tahun_priode-2 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-3 }}">{{ $tempstruk->tahun_priode-3 }}</option>
                            ...
                            <div class="card-body">
                                    <div class="col-md-12 p-5">
                                        <div class="table-responsive">
                                            <table id="tabel-ijinkualifikasi" class="table style table-striped table-hover tabel-ijinkualifikasi" style="width:100%">
                                            <thead class="text-white" style="background-color:#5BBCFF"> 
                                                <tr class="text-center">
                                                    <th rowspan="2">NO</th>
                                                    <th rowspan="2" text-align="center">UNIT KERJA</th>
                                            ...
                                            <tbody class="list bg-light">
                                            @foreach ($datapns_ijinkualifikasi as $temp)
                                                    <tr >
                                                        <td class="text-center">{{ $temp->idx}}</td>
                                                        <!-- <td>{{ $temp->id }}</td> -->
                                                        <td>{{ $temp->nama }}</td>
...
@push('scripts')
    ...
    $(document).ready(function () {
        ...
        $("#tabel-agama").dataTable({
         ...
         $("#tabel-ijinkualifikasi").dataTable({
                    "columnDefs": [
                        { "sortable": false }
                    ],
                    language: {
...
<script>
    var ChartOptionsPns = {
        ...
        var options = {
          series: [{
            name: "Desktops",
            data: @json($datachart_ijinkualifikasi)
        }],
          chart: {
          height: 290,
          type: 'line',
...
$('#pilih_tahun').on('change',function(){
  ...
  var url = 'get_charttatakelolapnsPangkat/'+this.value;
  ...
  $.ajax({
        ...
        success: function (data) {
            ...
            var data_ijinkualifikasi=data.datachart_ijinkualifikasi;
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelTatakelolaPnsPangkat/"+tahun+"/jkgol",
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelTatakelolaPnsPangkat/"+tahun+"/kualifikasi",
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelTatakelolaPnsPangkat/"+tahun+"/agama",
...
$('#pilih_ijinkualifikasi').on('change',function(){
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelTatakelolaPnsPangkat/"+tahun+"/ijinkualifikasi",
