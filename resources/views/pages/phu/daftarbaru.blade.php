...
<div class="main-content">
        <section class="section">
            <div class="section-header">
                <h3 >Data Pendaftar Baru Jemaah Haji</h3>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Data Pendaftar Baru Jemaah Haji</div>
                </div>
            </div>
        </section>  
  <div class="row">
        ...
        <div class="card shadow">
            <div class="card-header bg-succes border">
                <div class="row col-12 align-items-center">
                    <div class="col-8">
                        <h5 class=" mb-0">Pendaftar Baru Jemaah Haji Per Kabupaten Kota</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                    @if(Helper::cek_level_akses('layphu_daftarbaru')->l)     
                    <a class="nav-link {{request()->is('daftarbaru')?'active':null}}" id="kelamin-tab" data-toggle="tab" href="#kelamin" role="tab" aria-controls="" aria-selected="false">Berdasarkan Kelamin</a>
                    @endif
                    </li>
                    <li class="nav-item">
                    @if(Helper::cek_level_akses('layphu_daftarbaru')->l)   
                    ...
                    <li class="nav-item">
                    @if(Helper::cek_level_akses('layphu_daftarbaru')->l)
                    <a class="nav-link" id="batal-tab" data-toggle="tab" href="#batal" role="tab" aria-controls="batal" aria-selected="false">Pembatalan Pendaftaran Haji</a>
                    @endif
                    </li>
                            ...
                            <div class="card card-warning shadow">
                                <div class="card-header">
                                    <div class="col-md-6 text-left ">
                                        <h4>Data Pendaftar Baru Jemaah Haji Berdasarkan Jenis Kelamin Tahun {{ $tempstruk->tahun_priode }}</h4>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                ...
                                                @foreach ($datadaftarbarukelamin as $temp)
                                                        <tr >
                    ...
                    <!-- ------------------------------ End Jenis Kelamin ------------------------------  -->
                                        ...
                                        <div class="card card-success shadow">
                                            <div class="card-header">
                                                <div class="col-md-6 text-left mb-0 ">
                                                    <h4>Data Pendaftar Baru Jemaah Haji Berdasarkan Jenjang Pendidikan Tahun {{ $tempstruk->tahun_priode }} </h4>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="usia" role="tabpanel" aria-labelledby="usia-tab">
                            <div class="card card-success shadow">
                                <div class="card-header">
                                    <div class="col-md-6 text-left mb-0 ">
                                        <h4>Data Pendaftar Baru Jemaah Haji Berdasarkan Rentang Usia Tahun {{ $tempstruk->tahun_priode }}</h4>
                                    </div>
                                </div>
                                    <div class="col-md-12">
                                        <div class="table-responsive">       
                        ...
                        <!-- ----- End berdasarkan Usia------  -->
                            ...
                            <div class="tab-pane fade" id="pekerjaan" role="tabpanel" aria-labelledby="pekerjaan-tab">
                                    <div class="card card-success shadow">
                                        <div class="card-header">
                                            <div class="col-md-6 text-left mb-0 ">
                                                <h4>Data Pendaftar Baru Jemaah Haji Berdasarkan Jenis Pekerjaan Tahun {{ $tempstruk->tahun_priode }}</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="table-responsive">       
                ...
                <div class="tab-pane fade show active" id="pengalaman" role="tabpanel" aria-labelledby="pengalaman-tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data Pendaftar Baru Jemaah Haji Berdasarkan Pengalaman Berhaji Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade show active" id="batal" role="tabpanel" aria-labelledby="batal-tab">
                        
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data Pembatalan  Jemaah Haji  Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table id="tabel-batal" class="table style table-striped table-hover tabel-batal" style="width:100%">
                                            <thead class="text-white">
                                                <tr class="text-center">
                                                    <th >No</th>
                                                    <th text-align="center">Kabupaten / Kota</th>
                                            ...
                                            <tbody class="list bg-light">
                                            @foreach ($databatal as $temp)
                                                    <tr >
                                                        <td class="text-center">{{ $temp->idx}}</td>
                                                        <!-- <td>{{ $temp->id }}</td> -->
                                                        <td>{{ $temp->nama }}</td>
                                                        <td class="text-center"><a href="" class="batal_pria" data-type="number" data-name="batal_pria" data-pk="{{$temp->id}}">{{ number_format($temp->batal_pria) }}</a></td>
                                                        <td class="text-center"><a href="" class="batal_wanita" data-type="number" data-name="batal_wanita" data-pk="{{$temp->id}}">{{ number_format($temp->batal_wanita) }}</a></td>
                                                        <td class="text-center">{{ number_format($temp->batal_wanita+$temp->batal_pria) }}</td>
...
@push('scripts')
    ...
    $(document).ready(function () {
        ...
        $('.kurang_18').editable({
            url:"update_daftarbaru/kurang_18",
            type:'number',
            pk:1,
            name:'kurang_18',
            title:'Masukkan Jumlah',
        ...
        $('.rentang_18_50').editable({
            url:"update_daftarbaru/rentang_18_50",
            type:'number',
            pk:1,
            name:'rentang_18_50',
            title:'Masukkan Jumlah',
        ...
        $('.rentang_51_65').editable({
            url:"update_daftarbaru/rentang_51_65",
            type:'number',
            pk:1,
            name:'rentang_51_65',
            title:'Masukkan Jumlah',
        ...
        $('.rentang_66_75').editable({
            url:"update_daftarbaru/rentang_66_75",
            type:'number',
            pk:1,
            name:'rentang_66_75',
            title:'Masukkan Jumlah',
        ...
        $('.lebih_75').editable({
            url:"update_daftarbaru/lebih_75",
            type:'number',
            pk:1,
            name:'lebih_75',
            title:'Masukkan Jumlah',
        ...
        $('.tni_polri').editable({
            url:"update_daftarbaru/tni_polri",
            type:'number',
            pk:1,
            name:'tni_polri',
            title:'Masukkan Jumlah',
        ...
        $('.bumn_bumd').editable({
            url:"update_daftarbaru/bumn_bumd",
            type:'number',
            pk:1,
            name:'bumn_bumd',
            title:'Masukkan Jumlah',
        ...
        $('.lain_lain').editable({
            url:"update_daftarbaru/lain_lain",
            type:'number',
            pk:1,
            name:'lain_lain',
            title:'Masukkan Jumlah',
        ...
        $('.batal_pria').editable({
            url:"update_daftarbaru/batal_pria",
            type:'number',
            pk:1,
            name:'batal_pria',
            title:'Masukkan Jumlah',
        ...
        $('.batal_wanita').editable({
            url:"update_daftarbaru/batal_wanita",
            type:'number',
            pk:1,
            name:'batal_wanita',
            title:'Masukkan Jumlah',
