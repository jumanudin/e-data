        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Data Daftar Jemaah Haji</div>
                </div>
            </div>
        </section>  
  <div class="row">
        ...
        <div class="card shadow">
            <div class="card-header bg-succes border">
                <div class="row col-12 align-items-center">
                    <div class="col-8">
                        <h5 class=" mb-0">Daftar Jemaah Haji Per Kabupaten Kota</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                    @if(Helper::cek_level_akses('layphu_jemaah')->l)     
                    <a class="nav-link {{request()->is('jemaah_haji')?'active':null}}" id="kelamin-tab" data-toggle="tab" href="#kelamin" role="tab" aria-controls="" aria-selected="false">Berdasarkan Kelamin</a>
                    @endif
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="card card-warning shadow">
                                <div class="card-header">
                                    <div class="col-md-6 text-left ">
                                        <h4>Data Daftar Jemaah Haji Berdasarkan Jenis Kelamin Tahun {{ $tempstruk->tahun_priode }}</h4>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                ...
                                                @foreach ($datajemaahkelamin as $temp)
                                                        <tr >
                    ...
                    <!-- ------------------------------ End Jenis Kelamin ------------------------------  -->
                                        ...
                                        <div class="card card-success shadow">
                                            <div class="card-header">
                                                <div class="col-md-6 text-left mb-0 ">
                                                    <h4>Data  Jemaah Haji Berdasarkan Jenjang Pendidikan Tahun {{ $tempstruk->tahun_priode }} </h4>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="usia" role="tabpanel" aria-labelledby="usia-tab">
                            <div class="card card-success shadow">
                                <div class="card-header">
                                    <div class="col-md-6 text-left mb-0 ">
                                        <h4>Data Jemaah Haji Berdasarkan Rentang Usia Tahun {{ $tempstruk->tahun_priode }}</h4>
                                    </div>
                                </div>
                                    <div class="col-md-12">
                                        <div class="table-responsive">       
                        ...
                        <!-- ----- End berdasarkan Usia------  -->
                            ...
                            <div class="tab-pane fade" id="pekerjaan" role="tabpanel" aria-labelledby="pekerjaan-tab">
                                    <div class="card card-success shadow">
                                        <div class="card-header">
                                            <div class="col-md-6 text-left mb-0 ">
                                                <h4>Data Jemaah Haji Berdasarkan Jenis Pekerjaan Tahun {{ $tempstruk->tahun_priode }}</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="table-responsive">       
                ...
                <div class="tab-pane fade show active" id="pengalaman" role="tabpanel" aria-labelledby="pengalaman-tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data Jemaah Haji Berdasarkan Pengalaman Berhaji Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
...
@push('scripts')
    ...
    $(document).ready(function () {
        ...
        $('.rentang_18_50').editable({
            url:"update_jemaah/rentang_18_50",
            type:'number',
            pk:1,
            name:'rentang_18_50',
            title:'Masukkan Jumlah',
        ...
        $('.rentang_51_65').editable({
            url:"update_jemaah/rentang_51_65",
            type:'number',
            pk:1,
            name:'rentang_51_65',
            title:'Masukkan Jumlah',
        ...
        $('.rentang_66_75').editable({
            url:"update_jemaah/rentang_66_75",
            type:'number',
            pk:1,
            name:'rentang_66_75',
            title:'Masukkan Jumlah',
