...
<div class="main-content">
        <section class="section">
            <div class="section-header">
                <h3 >DATA PNS NAIK PANGKAT</h3>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ url('dashboard') }}"><i class="fas fa-home"></i></a></div>
                    <div class="breadcrumb-item"><a href="{{ route('naik_pangkat') }}">Layanan Tata Kelola & Dukungan Manajemen </a></div>
            ...
            <div class="card shadow">
                <div class="card-header bg-succes border">
                    <div class="row col-12 align-items-center">
                        <div class="col-8">
                            <h5 class=" mb-0">Data Naik Pangkat Per Kabupaten Kota</h5>
                        </div>
                    </div>
                </div>
            <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                            @if(Helper::cek_level_akses('laytatakelola_pns_pangkat')->l)     
                            <a class="nav-link {{request()->is('naik_pangkat')?'active':null}}" id="pns_jkgol-tab" data-toggle="tab" href="#pns_jkgol" role="tab" aria-controls="" aria-selected="false">Jenis Kelamin & Golongan</a>
                            @endif
                            </li>
                            <li class="nav-item">
                            @if(Helper::cek_level_akses('laytatakelola_pns_pangkat')->l)     
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data PNS Naik Pangkat Menurut Jenis Kelamin dan Golongan Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                 ...
                 <div class="tab-pane fade " id="pns_kualifikasi" role="tabpanel" aria-labelledby="pns_kualifikasi_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data PNS Naik Pangkat Menurut Kualifikasi Pendidikan Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                 ...
                 <div class="tab-pane fade show " id="pns_agama" role="tabpanel" aria-labelledby="pns_agama_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data PNS Naik Pangkat Berdasarkan Agama Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
...
@push('scripts')
    ...
    $(document).ready(function () {
        ...
        $('.kristen').editable({
            url:"update_naikpangkat/kristen",
            type:'number',
            pk:1,
            name:'kristen',
            title:'Masukkan Jumlah',
        ...
        $('.katolik').editable({
            url:"update_naikpangkat/katolik",
            type:'number',
            pk:1,
            name:'katolik',
            title:'Masukkan Jumlah',
        ...
        $('.khonghucu').editable({
            url:"update_naikpangkat/khonghucu",
            type:'number',
            pk:1,
            name:'khonghucu',
            title:'Masukkan Jumlah',
