...
<div class="main-content">
        <section class="section">
            <div class="section-header">
                <h3 >DATA PNS IJIN BELAJAR </h3>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ url('dashboard') }}"><i class="fas fa-home"></i></a></div>
                    <div class="breadcrumb-item"><a href="{{ route('ijin_belajar') }}">Layanan Tata Kelola & Dukungan Manajemen </a></div>
                    <div class="breadcrumb-item">PNS Ijin Belajar</div>
                </div>
            </div>
        </section>  
    <div class="row">
            ...
            <div class="card shadow">
                <div class="card-header bg-succes border">
                    <div class="row col-12 align-items-center">
                        <div class="col-8">
                            <h5 class=" mb-0">Data PNS Ijin Belajar Per Kabupaten Kota</h5>
                        </div>
                    </div>
                </div>
            <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <a class="nav-link {{request()->is('ijin_belajar')?'active':null}}" id="pns_kualifikasi_tab" data-toggle="tab" href="#pns_kualifikasi" role="tab" aria-controls="" aria-selected="false">Ijin Belajar Berdasarkan Kualifikasi</a>
                            @endif
                            </li>
                        </ul>    
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data PNS Ijin Belajar Menurut Jenjang Pendidikan Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
