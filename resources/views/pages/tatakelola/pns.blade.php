...
<div class="main-content">
        <section class="section">
            <div class="section-header">
                <h3 >DATA PEGAWAI NEGERI SIPIL</h3>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ url('pns') }}"><i class="fas fa-home"></i></a></div>
                    <div class="breadcrumb-item"><a href="{{ route('pns') }}">Layanan Tata Kelola & Dukungan Manajemen </a></div>
                    <div class="breadcrumb-item">PNS</div>
                </div>
            </div>
        </section>  
    <div class="row">
            ...
            <div class="card shadow">
                <div class="card-header bg-succes border">
                    <div class="row col-12 align-items-center">
                        <div class="col-8">
                            <h5 class=" mb-0">Data Pegawai Negeri Sipil Per Kabupaten Kota</h5>
                        </div>
                    </div>
                </div>
            <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                            @if(Helper::cek_level_akses('laytatakelola_pns')->l)     
                            <a class="nav-link {{request()->is('pns')?'active':null}}" id="pns_jkgol-tab" data-toggle="tab" href="#pns_jkgol" role="tab" aria-controls="" aria-selected="false">Jenis Kelamin & Golongan</a>
                            @endif
                            </li>
                            <li class="nav-item">
                            @if(Helper::cek_level_akses('laytatakelola_pns')->l)     
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data PNS Menurut Jenis Kelamin dan Golongan Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                    ...
                    <div class="tab-pane fade" id="pns_usia" role="tabpanel" aria-labelledby="pns_usia_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data PNS Menurut Usia Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            @foreach ($datapns_usia as $temp)
                                                    <tr >
                                                        ...
                                                        <!-- <td>{{ $temp->id }}</td> -->
                                                        <td>{{ $temp->nama }}</td>
                                                        <td class="text-center"><a href="" class="min_30" data-type="number" data-name="min_30" data-pk="{{$temp->id}}">{{ number_format($temp->min_30) }}</a></td>
                                                        <td class="text-center"><a href="" class="range_30_39" data-type="number" data-name="range_30_39" data-pk="{{$temp->id}}">{{ number_format($temp->range_30_39) }}</a></td>
                                                        <td class="text-center"><a href="" class="range_40_49" data-type="number" data-name="range_40_49" data-pk="{{$temp->id}}">{{ number_format($temp->range_40_49) }}</a></td>
                                                        <td class="text-center"><a href="" class="range_50_57" data-type="number" data-name="range_50_57" data-pk="{{$temp->id}}">{{ number_format($temp->range_50_57) }}</a></td>
                                                        <td class="text-center"><a href="" class="lebih_57" data-type="number" data-name="lebih_57" data-pk="{{$temp->id}}">{{ number_format($temp->lebih_57) }}</a></td>
                                                        <td class="text-center">{{ number_format($temp->min_30+$temp->range_30_39+$temp->range_40_49+$temp->range_50_57+$temp->lebih_57) }}</td>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                 ...
                 <div class="tab-pane fade " id="pns_kualifikasi" role="tabpanel" aria-labelledby="pns_kualifikasi_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data PNS Menurut Kualifikasi Pendidikan Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                 ...
                 <div class="tab-pane fade show " id="pns_agama" role="tabpanel" aria-labelledby="pns_agama_tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-6 text-left ">
                                    <h4>Data PNS Berdasarkan Agama Tahun {{ $tempstruk->tahun_priode }}</h4>
                                </div>
                            </div>
...
@push('scripts')
    ...
    $(document).ready(function () {
        ...
        $('.range_30_39').editable({
            url:"update_pns/range_30_39",
            type:'number',
            pk:1,
            name:'range_30_39',
            title:'Masukkan Jumlah',
        ...
        $('.range_40_49').editable({
            url:"update_pns/range_40_49",
            type:'number',
            pk:1,
            name:'range_40_49',
            title:'Masukkan Jumlah',
        ...
        $('.range_50_57').editable({
            url:"update_pns/range_50_57",
            type:'number',
            pk:1,
            name:'range_50_57',
            title:'Masukkan Jumlah',
