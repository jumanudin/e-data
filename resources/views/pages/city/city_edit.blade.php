<x-app-layout>
    ...
    <h1> {{ __('Kabupaten/Kota') }} </h1>
        ...
        <div class="breadcrumb-item active"><a href="{{ url('dashboard') }}">Dashboard</a></div>
            ...
            <div class="breadcrumb-item active">Edit Kabupaten/Kota</a></div>
        </div>
    </x-slot>
    <div class="section-body">
        <h2 class="section-title">Edit Data Kabupaten / Kota</h2>
        <p class="section-lead">Tekan tombol Update untuk menyimpan data Kabupaten atau Kota</p>
            ...
            {{ Form::open(['url'=>'city/edit/'.$kota->id, 'class' => 'form-horizontal', 'method'=>'post']) }}
            @csrf
                ...
                <div class="card-body">
                    <div class="form-group {{ $errors->has('kode') ? 'has-error' : '' }} row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" name="kode" class="form-control" value="{{ $kota->kode}}">
                    ...
                    <div class="form-group {{ $errors->has('ibukota') ? 'has-error' : '' }} row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" name="ibukota" class="form-control" value="{{ $kota->ibukota }}">
                    ...
                    <div class="card-footer">
                        <div class="text-right">
                            ...
                            <button type="submit" class="btn btn-sm btn-icon icon-left btn-primary"><i class="fas fa-save"></i>Update</button>
                        </div>
                    </div>
                </div>    
            </div>    
