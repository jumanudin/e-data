...
<div class="container-fluid mt--7"">
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-0">
                            <h3 class="mb-0">Daftar Riwayat Jabatan</h3>
                        </div>
                    </div>
                       ...
                       <div class="card ">
                        <div class="card-body">
                            <ul class="nav nav-pills flex-row">
                                ...
                                <li class="nav-item"><a href="{{url('pegawai/jabatan',Crypt::encryptString($peg->id)) }}" id="jabatan" class="click_menu nav-link active" >Jabatan</a></li>
    ...
    <div class="card author-box card-warning">
     <div class="card-header">
         <h4>Riwayat Data Jabatan </h4>
         <div class="section-header-button">
             <a href="/pegawai/jabatan_create/{{ Crypt::encryptString($peg->id) }}" class="btn btn-icon btn-left btn-primary"><i class="fas fa-plus"></i>Add New</a>
         </div>        
     </div>
     <div class="card-body">
         <div class="table-responsive">
             ...
             <tr>
                     ...
                     <th class="text-right">No. SK Jabatan</th>
                     <th class="text-right">Opsi</th>
             </tr>
             </thead>
             <tbody>
                 @foreach ($rijab as $temp)
                 <tr class="border-b border-gray-200 hover:bg-gray-100">
                     <td class="text-center">{{ ++$i}}</td>
                     <td>{{ $temp->nama_jab }}</td>
                     <td>{{ $temp->tmt_jab }}</td>
                     <td>{{ $temp->tgl_skjab }}</td>
                     <td>{{ $temp->no_skjab }}</td>
                     <td class="py-3 px-6 text-center"><div class="flex item-center justify-center">
                     <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                     <a role="button" href="/pegawai/jabatan/edit/{{ Crypt::encryptString($temp->id) }}/{{ $peg->id }}" class="mr-3"><i class="fa fa-16px fa-pen"></i></a></div>
                     <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
...
function open_modal(id) {
        $('.modal-message').modal();
        $('#submit_hapus').attr("href","{{url('pegawai/jabatan/hapus')}}/"+id);
      }
</script>
@stop
