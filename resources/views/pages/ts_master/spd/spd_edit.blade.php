@extends('layouts.app', ['title' => __('Edit Data Rinci Perjadin')])
<style>
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('buat_spd') }}">Inbox Detail Perjadin</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Edit Data Rinci Perjadin</li>
                </ol>
              </nav>
            </div>
          </div>
    ...
    <div class="col">
        <div class="card shadow p-1 rounded">
            <div class="card-header bg-primary">
                ...
                <i class="fa fa-chevron-down float-right"></i>
                &nbsp DATA RINCI SPD PEGAWAI 
                </a>        
            </div>
            <div id="collapse-2" class="collapse show" aria-labelledby="heading-collapsed">
                {{ Form::open(['url'=>'buat_spd/edit/'.$spd_master->id, 'class' => 'form-horizontal','method'=>'post']) }}
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group {{ $errors->has('tempat_berangkat') ? 'has-error' : '' }} row mb-2">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" id="tempat_berangkat" name="tempat_berangkat" class="form-control" value="{{ $spd_master->tempat_berangkat }}">
                    ...
                    <div class="form-group {{ $errors->has('tempat_tujuan') ? 'has-error' : '' }} row mb-2">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" id="tempat_tujuan" name="tempat_tujuan" class="form-control" value="{{ $spd_master->tempat_tujuan }}">
                    ...
                    <div class="form-group {{ $errors->has('pengikut1') ? 'has-error' : '' }} row mb-2">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" id="pengikut1" name="pengikut1" class="form-control" value="{{ $spd_master->pengikut1 }}">
                    ...
                    <div class="form-group {{ $errors->has('pengikut2') ? 'has-error' : '' }} row mb-2">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" id="pengikut2" name="pengikut2" class="form-control" value="{{ $spd_master->pengikut2 }}">
                    ...
                    <div class="form-group {{ $errors->has('akun') ? 'has-error' : '' }} row mb-2">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" id="akun" name="akun" class="form-control" value="{{ $spd_master->akun }}">
