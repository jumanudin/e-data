        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Buat Dupak</h6>
    ...
    <div class="col">
        <div class="card shadow">
            ...
            <h3 >Buat Form Dupak</h3>
                <p class="text-white"><strong>Silahkan dilengkapi data dengan benar,sesuai dengan data saat ini ..!</strong></p>


            {{ Form::open(['url'=>'buat_dupak/submit', 'class' => 'form-horizontal', 'method'=>'post']) }}
            @csrf
            <div class="form-group row mb-2">
                <label class="col-form-label text-md-left col-md-2 ">{{ __('Periode Usul DUPAK') }}</label>
                <div class="col-md-10">
                    <input class="form-control" type="date" id="periode" name="periode" value="{{ $periode->periode }}" readonly>
                </div>
            </div>  
            <div class="form-group row mb-2">
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" id="nama" name="nama" value="{{ $pegawai->nama }}" readonly>
                </div>
            </div>  
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-5">
                    <input class="form-control{{ $errors->has('tempat_lahir') ? ' is-invalid' : '' }}" type="text" id="tempat_lahir" name="tempat_lahir" value="{{ $pegawai->tempat_lahir }}" >
                ...
                <div class="col-md-5">
                    <input class="form-control{{ $errors->has('tgl_lahir') ? ' is-invalid' : '' }}" type="date" id="tgl_lahir" name="tgl_lahir" value="{{ $pegawai->tgl_lahir }}" >
            ...
            <div class="form-group row mb-2">                    
                ...
                <div class="col-md-10" >
                    ...
                    @foreach ($agama as $key=> $value)
                        <option value="{{ $key }}" {{ $key == $pegawai->agama ? 'selected': '' }}>{{ $value }}</option>
                    @endforeach
                    </select>
                    @if ($errors->has('agama'))
                    <span class="invalid-feedback" style="display: block;" role="alert">
            ...
            <div class="form-group row mb-2">                    
                ...
                <div class="col-md-10" >
                    ...
                    @foreach ($kua as $key=> $value)
                        <option value="{{ $key }}" {{ $key == $pegawai->kode_satker ? 'selected': '' }}>{{ $value }}</option>
                    @endforeach
                    </select>
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-5">
                    <input class="form-control{{ $errors->has('mp_awal') ? ' is-invalid' : '' }}" type="date" name="mp_awal" id="mp_awal" >
                ...
                <div class="col-md-5">
                    <input class="form-control{{ $errors->has('mp_akhir') ? ' is-invalid' : '' }}" type="date" name="mp_akhir" id="mp_akhir" >
            ...
            <label class="col-form-label text-md-left col-md-5 ">{{ __('Pendidikan Yang Sudah Diperhitungkan AK nya') }}</label>
                <div class="col-md-7" >
                    <select class="select2 form-control" data-placeholder="--Pilih Tingkat Pendidikan --" data-live-search="true" id="pendidikan" name="pendidikan" >
                        ...
                        <option value="{{ $key }}" {{ $key == $pegawai->pendidikan ? 'selected': '' }}>{{ $value }}</option>
                            @endforeach
                    </select>
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-10">
                    <input class="form-control{{ $errors->has('nama_pendidikan') ? ' is-invalid' : '' }}" type="text" id="nama_pendidikan" name="nama_pendidikan" >
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-5">
                    <select class="form-control" data-placeholder="--Pilih Pangkat dan Golongan --" data-live-search="true" id="panggol" name="panggol" >
                        <option value=""></option>
                        @foreach ($gol as $key=> $value)
                        <option value="{{ $key }}" {{ $key == $pegawai->kode_golongan ? 'selected' : ''}}>{{ $value.' ('.$key.')' }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-5">    
                    <input class="form-control{{ $errors->has('tmt_panggol') ? ' is-invalid' : '' }}" type="date" id="tmt_panggol" name="tmt_panggol" value="{{ $pegawai->tmt_gol }}" >
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-5">
                    <select class="select2 form-control" data-placeholder="--Pilih Jabatan --" data-live-search="true" id="jabatan" name="jabatan" >
                        ...
                        <option value="{{ $key }}" {{ $key == $pegawai->jabatan ? 'selected' : ''}}>{{ $value}}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-5">    
                    <input class="form-control{{ $errors->has('tmt_jabatan') ? ' is-invalid' : '' }}" type="date" name="tmt_jabatan" value="{{ $pegawai->tmt_jabatan }}" >
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-9">
                    <input type="text" name="pak_lama" id="pak_lama" class="form-control" value="{{ old('pal_lama') }}">
            ...
            <div class="form-group {{ $errors->has('mktahun_lama') ? 'has-error' : '' }} row mb-2">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="mktahun_lama" class="form-control" value="{{ old('mktahun_lama') }}">
                ...
                <div class="col-md-3">
                    <input type="number" name="mkbulan_lama" class="form-control" value="{{ old('mkbulan_lama') }}">
            ...
            <div class="form-group {{ $errors->has('mktahun_baru') ? 'has-error' : '' }} row mb-2">
                ...
                <div class="col-md-3">
                    <input type="number" name="mktahun_baru" class="form-control" value="{{ old('mktahun_baru') }}">
                ...
                <div class="col-md-3 mb-4">
                    <input type="number" name="mkbulan_baru" class="form-control" value="{{ old('mkbulan_baru') }}">
            ...
            <div class="form-group {{ $errors->has('ttd_tempat') ? 'has-error' : '' }} row mb-1">    
                ...
                <div class="col-md-4">                    
                    <input type="text" name="ttd_tempat" class="form-control" value="{{ old('ttd_tempat') }}">
            ...
            <div class="form-group {{ $errors->has('ttd_pejabat') ? 'has-error' : '' }} row mb-2">    
                <label class="col-form-label text-md-left col-md-2">Tempat TTD</label>                        
                <div class="col-md-4">
                    <input type="text" name="ttd_pejabat" class="form-control" value="{{ old('ttd_pejabat') }}">
                ...
                <label class="col-form-label text-md-left col-md-2">Tanggal TTD</label>
                <div class="col-md-4">
                    <input type="date" name="tgl_ttdpejabat" class="form-control" value="{{ old('tgl_ttdpejabat') }}">
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-10">
                    <input type="text" name="nip_pejabat" class="form-control" value="{{ old('nip_pejabat') }}">
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-10">
                    <input type="text" name="nama_pejabat" class="form-control" value="{{ old('nama_pejabat') }}">
