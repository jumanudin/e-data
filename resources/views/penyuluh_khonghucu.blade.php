@extends('layouts.web', ['title' => __('Data Penyuluh Agama Khonghucu')])
@push('style')
...
@section('main')
            ...
            <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">  
                                <a class="nav-link active" id="khonghucu_chart-tab" data-toggle="tab" href="#khonghucu_chart" role="tab" aria-controls="" aria-selected="false">Chart Penyuluh Khonghucu</a>
                            </li>
                            <li class="nav-item">  
                            <a class="nav-link " id="penyuluhkhonghucu-tab" data-toggle="tab" href="#penyuluhkhonghucu" role="tab" aria-controls="" aria-selected="false">Tabel Penyuluh Agama Khonghucu</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link " id="penyuluhpns-tab" data-toggle="tab" href="#penyuluhpns" role="tab" aria-controls="" aria-selected="false">Tabel Penyuluh PNS Agama Khonghucu</a>       </li>
                            <li class="nav-item">   
                            <a class="nav-link " id="penyuluhnonpns-tab" data-toggle="tab" href="#penyuluhnonpns" role="tab" aria-controls="" aria-selected="false">Tabel Penyuluh Non PNS Agama Khonghucu</a>
                            </li>
                        ...
                        <div class="tab-pane fade show active" id="khonghucu_chart" role="tabpanel" aria-labelledby="khonghucu_chart_tab">
                        
                                <div class="card card-warning shadow">
                                    <div class="card-header">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8 "><h5>GRAFIK DATA PENYULUH AGAMA KHONGHUCU </h5></div>
                                    ...
                                    <div class="card-body">
                                        <div class="row p-2">
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Penyuluh Agama Khonghucu</h5>
                                                        <div id="chart"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Penyuluh Agama Khonghucu PNS</h5>
                                                        <div id="chart2"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6 ">
                                                <div class="card" >
                                                    <div class="card-body">
                                                    <h5 class="card-title">Grafik Penyuluh Agama Khonghucu Non PNS</h5>
                                                        <div id="chart3"></div>
                                                    </div>
                                                </div>                  
                                            </div>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                            ...
                            <!-- ------- TABEL Penyuluh Agama khonghucu---------------------- -->


                        <div class="tab-pane fade show " id="penyuluhkhonghucu" role="tabpanel" aria-labelledby="penyuluhkhonghucu-tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="row">
                                                <div class="col-md-8 "><h5> DATA PENYULUH AGAMA KHONGHUCU</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                                                        
                                                    </div>
                                                    <div class="col-md-2 text-left ">
                                                        <select class="form-select form-select-lg" id="pilih_khonghucu" aria-label="Default select example">
                                                            <option selected value="{{ $tempstruk->tahun_priode }}">{{ $tempstruk->tahun_priode }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-1 }}">{{ $tempstruk->tahun_priode-1 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-2 }}">{{ $tempstruk->tahun_priode-2 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-3 }}">{{ $tempstruk->tahun_priode-3 }}</option>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                     <!-- ------- TABEL DATA PNS AGAMA khonghucu--------------------- -->
                     ...
                     <div class="tab-pane fade" id="penyuluhpns" role="tabpanel" aria-labelledby="penyuluhpns-tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PNS AGAMA KHONGHUCU</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                                                        
                                                    </div>
                                                    <div class="col-md-2 text-left ">
                                                        <select class="form-select form-select-lg" id="pilih_pnskhonghucu" aria-label="Default select example">
                                                            <option selected value="{{ $tempstruk->tahun_priode }}">{{ $tempstruk->tahun_priode }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-1 }}">{{ $tempstruk->tahun_priode-1 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-2 }}">{{ $tempstruk->tahun_priode-2 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-3 }}">{{ $tempstruk->tahun_priode-3 }}</option>
                            ...
                            <div class="card-body">
                                    <div class="col-md-12 p-5">
                                        <div class="table-responsive">
                                        <table id="tabel-pnskhonghucu" class="table style table-striped table-hover tabel-pnskhonghucu" style="width:100%">
                                           <thead class="text-white" style="background-color:#5BBCFF">
                                           <tr class="text-center">
                                                    <th rowspan="2" >No</th>
                                                    <th rowspan="2" text-align="center">Kabupaten / Kota</th>
                ...
                <!-- ------------------------------ End  ------------------------------  -->
                 ...
                 <!-- ------- Penyuluh Agama khonghucu Non PNS---------------------- -->
                 ...
                 <div class="tab-pane fade" id="penyuluhnonpns" role="tabpanel" aria-labelledby="penyuluhnonpns-tab">
                        ...
                        <div class="card card-warning shadow">
                            <div class="card-header">
                                <div class="col-md-12  ">
                                    <div class="row">
                                                <div class="col-md-8 "><h5>DATA PENYULUH AGAMA KHONGHUCU NON PNS</h5></div>
                                                    <div class="col-md-2 text-center "><h5>PILIH TAHUN</h5>
                                                        
                                                    </div>
                                                    <div class="col-md-2 text-left ">
                                                        <select class="form-select form-select-lg" id="pilih_nonpnskhonghucu" aria-label="Default select example">
                                                            <option selected value="{{ $tempstruk->tahun_priode }}">{{ $tempstruk->tahun_priode }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-1 }}">{{ $tempstruk->tahun_priode-1 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-2 }}">{{ $tempstruk->tahun_priode-2 }}</option>
                                                            <option value="{{ $tempstruk->tahun_priode-3 }}">{{ $tempstruk->tahun_priode-3 }}</option>
                            ...
                            <div class="card-body">
                                    <div class="col-md-12 p-5">
                                        <div class="table-responsive">
                                        <table id="tabel-nonpnskhonghucu" class="table style table-striped table-hover tabel-nonpnskhonghucu" style="width:100%">
                                        <thead class="text-white" style="background-color:#5BBCFF">
                                        <tr class="text-center">
                                                    <th rowspan="2" >No</th>
                                                    <th rowspan="2" text-align="center">Kabupaten / Kota</th>
...
@push('scripts')
    ...
    $(document).ready(function () {
        ...
        $("#tabel-pnskhonghucu").dataTable({
            ...
            $("#tabel-nonpnskhonghucu").dataTable({
                    "columnDefs": [
                        { "sortable": false }
                    ],
                    language: {
...
//    ----------------------- CHART 1 ----------------------------------------------------------
 ...
 //====================== CHART PENYULUH AGAMA khonghucu ==================

 var ChartOptionsPenyuluhkhonghucu = {
          series: [{
          data: @json($datachart_penyuluhkhonghucu)
        }],
          chart: {
          height: 290,
          type: 'bar',
        ...
        var chart = new ApexCharts(document.querySelector("#chart"), ChartOptionsPenyuluhkhonghucu);
        chart.render();
...
//====================== CHART PENYULUH AGAMA khonghucu PNS==================
    

            
var ChartOptionsPenyuluhpnskhonghucu= {
          series: [{
          data: @json($datachart_pnskhonghucu)
        }],
          chart: {
          height: 290,
          type: 'bar',
        ...
        var chart2 = new ApexCharts(document.querySelector("#chart2"), ChartOptionsPenyuluhpnskhonghucu);
        chart2.render();
...
var ChartOptionsPenyuluhnonpns = {
          series: [{
          data: @json($datachart_nonpnskhonghucu)
        }],
          chart: {
          height: 290,
          type: 'bar',
...
$('#pilih_tahun').on('change',function(){
  ...
  var url = 'get_chartkeagamaankhonghucu/'+this.value;
  ...
  $.ajax({
        ...
        success: function (data) {
            ...
            var datatpenyulukhonghucu=data.datachart_penyuluhkhonghucu;
            var datapns_khonghucu=data.datachart_pnskhonghucu;
            var datanonpns_khonghucu=data.datachart_nonpnskhonghucu;
...
// =========================== untuk Mengubah Data Tabel Keagamaan Penyuluh khonghucu Berdasarkan tahun=================== 

$('#pilih_khonghucu').on('change',function(){
...
var tahun=this.value;
                ...
                serverSide: true,
                searching: false,
                ajax: "getTabelKeagamaankhonghucu/"+tahun+"/penyuluhkhonghucu",
...
$('#pilih_pnskhonghucu').on('change',function(){
...
var tahun=this.value;
       ...
       $('#pilih_nonpnskhonghucu').on('change',function(){
