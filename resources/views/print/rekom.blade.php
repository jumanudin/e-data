...
<head>
    <meta charset="utf-8">
    <title>Surat Rekomendasi Surat Perjalanan Dinas Perihal {{$data->perihal}}</title>
    ...
    <page size ="A4">
        <div class="marginpage" align="">
            ...
            <tr>
                <table style="width: 100%;">
                <td style="line-height: 5px;" align="center">
                    <h1>SURAT PERSETUJUAN PERJALANAN DINAS</h1>   
                ...
                <div class="text-center judul-16">                    
                    ...
                    <tr>
                        <td colspan="2">Dengan ini memberi persetujuan kepada : <br/><br/></td>
                    </tr>  
                    @php
                    $golongan="";
                    @endphp
                    ...
                    @endforeach 
                    <tr><td colspan="2">Untuk melakukan perjalan dinas sesuai dengan perihal di atas</td></tr>
					</table>
                </div>
                <table style="width: 100%;" class="judul-16">
                    ...
                    <tr>
                        <td colspan="2">
                            <hr>
                            <p class="judul-10">Halaman ini sudah di generate dengan token unik {{$data->file_rekom}}</p>
                        </td>
                    </tr>
                </table>
            </div>
